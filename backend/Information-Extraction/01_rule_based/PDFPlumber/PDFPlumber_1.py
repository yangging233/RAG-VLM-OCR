...
if __name__ == "__main__":
    ...
    output_dir = "/home/data/nongwa/workspace/Information-Extraction/01_rule_based/PDFPlumber/output/阿里开发手册-泰山版-Visualization/阿里开发手册-泰山版.md"
    ...
    if os.path.exists(pdf_path):
        ...
        pdf_to_markdown_pure(
            pdf_path, 
            output_dir,
            enable_visualization=False  # 改为True启用可视化
        )
    else:
