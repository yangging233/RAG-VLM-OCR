...
VL_MODEL_DIR = os.getenv("PADDLEOCR_VL_MODEL_DIR", "/home/data/nongwa/workspace/model/02_OcrRag/PaddleOCR-VL-0.9B")
LAYOUT_MODEL_DIR = os.getenv("PADDLEOCR_LAYOUT_MODEL_DIR", "/home/data/nongwa/workspace/model/02_OcrRag/PP-DocLayoutV2")
GPU_ID = os.getenv("PADDLEOCR_VL_GPU_ID", "1")
PORT = int(os.getenv("PADDLEOCR_VL_API_PORT", "8802"))
HOST = os.getenv("PADDLEOCR_VL_API_HOST", "0.0.0.0")
# ===============================
